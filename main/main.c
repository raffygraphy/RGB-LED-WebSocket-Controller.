...
#define RED_PIN   12  // GPIO pin for the red color of RGB LED
#define GREEN_PIN 13  // GPIO pin for the green color of RGB LED
#define BLUE_PIN  14  // GPIO pin for the blue color of RGB LED
...
static void update_rgb_led_state(void)
{
    gpio_set_level(RED_PIN, led_state & 0x04);   // RED: Bit 2
    gpio_set_level(GREEN_PIN, led_state & 0x02); // GREEN: Bit 1
    gpio_set_level(BLUE_PIN, led_state & 0x01);  // BLUE: Bit 0
}
...
static void ws_async_send(void *arg)
{
    ...
    led_state = (led_state + 1) % 8;  // Cycle through 0b000 to 0b111
    update_rgb_led_state();
    ESP_LOGE(TAG, "LED State: %d", led_state);
    char buff[4];
